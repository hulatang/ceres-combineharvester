...
from ceres.cmds.passphrase_funcs import get_current_passphrase
from ceres.daemon.client import DaemonProxy, connect_to_daemon_and_validate
from ceres.util.keychain import KeyringMaxUnlockAttempts
from ceres.util.service_groups import services_for_groups
...
async def async_start(root_path: Path, group: str, restart: bool) -> None:
    ...
    if daemon is None:
        print("Failed to create the ceres daemon")
        return None
