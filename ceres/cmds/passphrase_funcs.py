...
from ceres.daemon.client import acquire_connection_to_daemon
from ceres.util.keychain import Keychain, obtain_current_passphrase
from ceres.util.keyring_wrapper import DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE
from ceres.util.ws_message import WsRpcMessage
...
def initialize_passphrase() -> None:
    if Keychain.has_master_passphrase():
        ...
        print("\nUse 'ceres passphrase set' or 'ceres passphrase remove' to update or remove your passphrase")
        sys.exit(1)
