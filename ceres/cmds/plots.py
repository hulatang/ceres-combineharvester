...
def show_plots(root_path: Path):
    from ceres.plotting.util import get_plot_directories
...
def create_cmd(
    ...
    from ceres.plotting.create_plots import create_plots, resolve_plot_keys
...
def remove_cmd(ctx: click.Context, final_dir: str):
    from ceres.plotting.util import remove_plot_directory
