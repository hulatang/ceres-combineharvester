...
from ceres.consensus.block_rewards import calculate_base_farmer_reward
from ceres.pools.pool_wallet import PoolWallet
from ceres.pools.pool_wallet_info import create_pool_state, FARMING_TO_POOL, PoolWalletInfo, PoolState
...
from ceres.util.keychain import KeyringIsLocked, bytes_to_mnemonic, generate_mnemonic
from ceres.util.path import path_from_root
from ceres.util.ws_message import WsRpcMessage, create_payload_dict
from ceres.wallet.cc_wallet.cc_wallet import CCWallet
from ceres.wallet.derive_keys import master_sk_to_singleton_owner_sk
...
from ceres.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from ceres.wallet.util.trade_utils import trade_record_to_dict
...
from ceres.wallet.wallet_node import WalletNode
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from ceres.pools.pool_wallet_info import initial_pool_state_from_dict
