...
from ceres.consensus.multiprocess_validation import PreValidationResult
...
from ceres.pools.pool_puzzles import SINGLETON_LAUNCHER_HASH
from ceres.protocols import wallet_protocol
from ceres.protocols.full_node_protocol import RequestProofOfWeight, RespondProofOfWeight
from ceres.protocols.protocol_message_types import ProtocolMessageTypes
from ceres.protocols.wallet_protocol import (
...
from ceres.server.node_discovery import WalletPeers
...
from ceres.util.check_fork_next_block import check_fork_next_block
from ceres.util.errors import Err, ValidationError
from ceres.util.ints import uint32, uint128
from ceres.util.keychain import Keychain
from ceres.util.lru_cache import LRUCache
from ceres.util.merkle_set import MerkleSet, confirm_included_already_hashed, confirm_not_included_already_hashed
from ceres.util.path import mkdir, path_from_root
from ceres.wallet.block_record import HeaderBlockRecord
from ceres.wallet.derivation_record import DerivationRecord
from ceres.wallet.settings.settings_objects import BackupInitialized
...
from ceres.wallet.wallet_blockchain import ReceiveBlockResult
from ceres.wallet.wallet_state_manager import WalletStateManager
from ceres.util.profiler import profile_task
...
class WalletNode:
    ...
    async def get_key_for_fingerprint(self, fingerprint: Optional[int]) -> Optional[PrivateKey]:
        ...
        try:
            ...
            self.log.warning("No keys present. Create keys with the UI, or with the 'ceres keys' program.")
            return None
