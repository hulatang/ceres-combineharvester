...
from ceres.types.coin_solution import CoinSolution
...
from ceres.wallet.cc_wallet.cc_utils import CC_MOD, SpendableCC, spend_bundle_for_spendable_ccs, uncurry_cc
from ceres.wallet.cc_wallet.cc_wallet import CCWallet
from ceres.wallet.puzzles.genesis_by_coin_id_with_0 import genesis_coin_id_for_genesis_coin_checker
from ceres.wallet.trade_record import TradeRecord
from ceres.wallet.trading.trade_status import TradeStatus
from ceres.wallet.trading.trade_store import TradeStore
from ceres.wallet.transaction_record import TransactionRecord
from ceres.wallet.util.trade_utils import (
...
# from ceres.wallet.cc_wallet.debug_spend_bundle import debug_spend_bundle
                ...
                if my_cc_spends is None or my_cc_spends == set():
                    ...
                    if zero_spend_bundle is None:
                        return (
                            False,
                            None,
                            "Unable to generate zero value coin. Confirm that you have ceres available",
                        )
