from socks.util.ints import uint64
...
testnet_kwargs = {
    ...
    "MIN_PLOT_SIZE": 28,  # 32 enable more devices to participate in network
    "MAX_PLOT_SIZE": 50,
    ...
    # Forks of socks should change this value to provide replay attack protection. This is set to mainnet genesis chall
