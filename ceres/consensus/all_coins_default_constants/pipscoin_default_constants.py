...
testnet_kwargs = {
    ...
    "GENESIS_CHALLENGE": bytes.fromhex("3af6e0d6c6a1da419561a832f69f23be905262f40f2eeadbeded167612b01f92"),
    # Forks of pipscoin should change this value to provide replay attack protection. This is set to mainnet genesis chall
    "AGG_SIG_ME_ADDITIONAL_DATA": bytes.fromhex("ee8b944de335e63d5e4f301e5dec0c8e0d6f227007deb4ba47be7e0ae353437a"),
    "GENESIS_PRE_FARM_POOL_PUZZLE_HASH": bytes.fromhex(
        "bd02ce270f62bcaa7ed377cbfb98ee4fa5bebfbead539a3c548de464a2e71af2"
    ),
