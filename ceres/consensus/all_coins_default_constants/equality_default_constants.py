...
testnet_kwargs = {
    ...
    # Forks of equality should change this value to provide replay attack protection. This is set to mainnet genesis chall
    "AGG_SIG_ME_ADDITIONAL_DATA": bytes.fromhex("51eba4337730166c62b4ef2eb4ac5cdd670f48f46b9725d3e5c31d9c7a662d08"),
    "GENESIS_PRE_FARM_POOL_PUZZLE_HASH": bytes.fromhex(
        "f5d2e187eee83c9d046849cd5314b2bcb3dd7af0f08aa7624442a83757f6324f"
    ),
