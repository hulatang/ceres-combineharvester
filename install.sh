...
if [ "$(uname -m)" = "armv7l" ]; then
  echo ""
	echo "WARNING:"
	echo "The Ceres Blockchain requires a 64 bit OS and this is 32 bit armv7l"
	echo "For more information, see"
	echo "https://github.com/Ceres-Network/ceres-blockchain/wiki/Raspberry-Pi"
	echo "Exiting."
	exit 1
fi
# Get submodules
...
echo ""
echo "Try the Quick Start Guide to running ceres-blockchain:"
echo "https://github.com/Chia-Network/ceres-blockchain/wiki/Quick-Start-Guide"
echo ""
# echo "To install the GUI type 'sh install-gui.sh' after '. ./activate'."
echo ""
echo "Type '. ./activate' and then 'ceres init' to begin."
echo "Type 'ceres init --coins' to generate the fork configure."
echo "Type 'ceres generate_ssl' to generate ca files"
echo "See github readme for detail."
