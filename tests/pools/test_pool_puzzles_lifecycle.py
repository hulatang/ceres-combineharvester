...
from ceres.wallet.puzzles.p2_conditions import puzzle_for_conditions
from ceres.wallet.puzzles import singleton_top_layer
from ceres.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - ceres.pools.pool_puzzles.py
    - ceres.wallet.puzzles.pool_member_innerpuz.clvm
    - ceres.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
