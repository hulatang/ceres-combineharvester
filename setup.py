...
kwargs = dict(
    ...
    entry_points={
        "console_scripts": [
            ...
            "chia_wallet = ceres.server.start_wallet:main",
            "chia_full_node = ceres.server.start_full_node:main",
            "chia_harvester = ceres.server.start_harvester:main",
            "chia_farmer = ceres.server.start_farmer:main",
            "chia_introducer = ceres.server.start_introducer:main",
            "chia_timelord = ceres.server.start_timelord:main",
            "chia_timelord_launcher = ceres.timelord.timelord_launcher:main",
            "chia_full_node_simulator = ceres.simulator.start_simulator:main",
        ]
    },
    package_data={
